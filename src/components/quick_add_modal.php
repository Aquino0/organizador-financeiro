            ...
            <form id="quickAddForm" onsubmit="submitQuickAdd(event)">
                ...
                <div class="flex items-center gap-6 mb-6">
                    <label class="group cursor-pointer flex items-center gap-2">
                        <input type="radio" name="tipo" value="despesa" class="peer sr-only" checked onchange="handleTypeChange('despesa')">
                        <div class="w-5 h-5 rounded-full border-2 border-slate-400 peer-checked:border-[#ef4444] peer-checked:bg-[#ef4444] transition-all relative"></div>
                        <span class="text-slate-300 font-medium peer-checked:text-white">Despesa</span>
                    </label>

                    <label class="group cursor-pointer flex items-center gap-2">
                        <input type="radio" name="tipo" value="receita" class="peer sr-only" onchange="handleTypeChange('receita')">
                        <div class="w-5 h-5 rounded-full border-2 border-slate-400 peer-checked:border-[#22c55e] peer-checked:bg-[#22c55e] transition-all relative"></div>
                ...
                <!-- Description -->
                <div class="mb-4">
                    <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Descrição</label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Valor</label>
                        <div class="relative">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Data</label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Conta/Cartão</label>
                        <select name="conta" 
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-400 mb-1.5 uppercase tracking-wide">Categoria</label>
                        <div class="relative">
                ...
                <div class="flex justify-end mb-8">
                    <div class="bg-[#334155] rounded-full px-4 py-2 flex items-center gap-3 border border-slate-600">
                        <span class="text-slate-300 text-sm font-medium">Status: <span id="statusLabel" class="text-white font-bold">A Pagar</span></span>
                        
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="pago" class="sr-only peer" id="statusCheckbox" onchange="toggleStatusLabel()">
                ...
                <div class="flex justify-between px-4 mb-8">
                    ...
                    <button type="button" onclick="toggleRepeat()" class="flex flex-col items-center gap-2 group">
                        <div class="w-12 h-12 rounded-full border border-slate-600 flex items-center justify-center text-slate-400 group-hover:border-blue-500 group-hover:text-blue-500 transition-colors" id="btnRepeatCircle">
                    ...
                    <button type="button" onclick="toggleObs()" class="flex flex-col items-center gap-2 group">
                        <div class="w-12 h-12 rounded-full border border-slate-600 flex items-center justify-center text-slate-400 group-hover:border-blue-500 group-hover:text-blue-500 transition-colors" id="btnObsCircle">
                    ...
                    <button type="button" class="flex flex-col items-center gap-2 group opacity-50 hover:opacity-100 transition-opacity">
                ...
                <div id="hiddenFields" class="space-y-4 mb-6">
                    ...
                    <div id="quickRepeatField" class="hidden">
                        <div class="bg-[#334155] p-3 rounded-lg border border-slate-600">
                            <label class="block text-xs font-bold text-slate-400 mb-2 uppercase tracking-wide">Repetir Lançamento</label>
                            <div class="flex items-center gap-3">
                                <select name="repeat_type" class="bg-slate-700 text-white rounded px-3 py-2 text-sm border border-slate-600 focus:outline-none">
                ...
                <div class="flex justify-center -mb-24 relative z-20">
                    <button type="button" onclick="document.getElementById('quickAddForm').requestSubmit()" id="btnQuickSave"
